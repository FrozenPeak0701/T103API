...
def receiveASDU2(ASDU) -> dict:  # time tagged message with relative time
    ...
    INFO = dict1['INFO']
    del dict1['INFO']
    if dict1['VSQ'] != 0x81 or len(INFO) != 10:
...
def receiveASDU4(ASDU) -> dict:  # time-tagged measurands with relative timme
    ...
    INFO = dict1['INFO']
    del dict1['INFO']
    if dict1['VSQ'] != 0x81 or len(INFO) != 12:
...
def receiveASDU5(ASDU) -> dict:  # identification message
    ...
    del dict1['INFO']
    COL = INFO[0]
    if dict1['VSQ'] != 0x81 or len(INFO) != 13 or dict1['INF'] not in (
...
def receiveASDU6(ASDU) -> dict:  # time synchronization
    ...
    INFO = dict1['INFO']
    del dict1['INFO']
    if dict1['VSQ'] != 0x81 or len(INFO) != 7 or dict1['FUN'] != 255 or dict1['INF'] != 0:
...
def receiveASDU8(ASDU) -> dict:  # termination of general interrogation
    ...
    INFO = dict1['INFO']
    del dict1['INFO']
    if dict1['VSQ'] != 0x81 or len(INFO) != 1 or dict1['FUN'] != 0xff or dict1['INF'] != 0x00:
...
def receiveASDUCD(ASDU) -> dict:
    ...
    INFO = dict1['INFO']
    del dict1['INFO']
    if dict1['VSQ'] != 0x81 or len(INFO) != 8:
